...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Business Management Tool for io-gen" },
      { name: "description", content: "IO-Gen internal operations and CRM platform." },
      { property: "og:title", content: "Business Management Tool for io-gen" },
      { name: "twitter:title", content: "Business Management Tool for io-gen" },
      { property: "og:description", content: "IO-Gen internal operations and CRM platform." },
      { name: "twitter:description", content: "IO-Gen internal operations and CRM platform." },
